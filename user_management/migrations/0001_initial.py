# Generated by Django 3.1.3 on 2022-12-23 03:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_typecompany', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('type_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_management.typecompany')),
            ],
            options={
